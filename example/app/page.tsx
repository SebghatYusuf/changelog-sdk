  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 flex flex-col items-center justify-center p-8 gap-12">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl">
        {[
          { href: "/changelog", icon: "📋", title: "Public Feed", desc: "/changelog", color: "from-blue-600/20 to-blue-400/20 hover:from-blue-600/30 hover:to-blue-400/30 border-blue-500/30 hover:border-blue-400/60" },
          { href: "/changelog/admin", icon: "🔐", title: "Admin Portal", desc: "/changelog/admin", color: "from-purple-600/20 to-purple-400/20 hover:from-purple-600/30 hover:to-purple-400/30 border-purple-500/30 hover:border-purple-400/60" },
          { href: "/changelog/login", icon: "🔑", title: "Admin Login", desc: "/changelog/login", color: "from-emerald-600/20 to-emerald-400/20 hover:from-emerald-600/30 hover:to-emerald-400/30 border-emerald-500/30 hover:border-emerald-400/60" },
          { href: "/changelog/entry/your-slug-here", icon: "📄", title: "Single Entry", desc: "/changelog/entry/:slug", color: "from-amber-600/20 to-amber-400/20 hover:from-amber-600/30 hover:to-amber-400/30 border-amber-500/30 hover:border-amber-400/60" },
        ].map((card) => (
          <a
            key={card.href}
            href={card.href}
